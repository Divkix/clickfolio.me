...
export const metadata: Metadata = {
  title: "Free Resume Website for Students | clickfolio.me",
  description:
  ...
  alternates: { canonical: `${siteConfig.url}/for/student` },
  openGraph: {
    title: "Free Resume Website for Students | clickfolio.me",
    description:
      "Build your first online portfolio as a student — free, with no signup. Upload your PDF resume and get a shareable website with education, projects, and skills sections.",
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-[#6B6B6B] list-disc pl-5">
            ...
            <li>
              ...
              by internship and entry-level job portals. Your portfolio works as both a website and
              a resume.
            </li>
            <li>
            ...
            <li>
              ...
              coursework, projects, skills, and extracurriculars into visually distinct, impressive
              cards.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-[#6B6B6B] mb-4">
            Most students apply with a PDF. You'll apply with a live website. Share your @handle URL
            on internship applications, LinkedIn, and with recruiters at career fairs. It shows
            initiative, technical skill, and attention to detail.
          </p>
