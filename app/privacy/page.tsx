...
const SECTIONS: { title: string; body: ReactNode }[] = [
    ...
    body: (
      <>
        <p className="text-muted-foreground leading-relaxed">
          {siteConfig.fullName} (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is committed to
          protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and
          safeguard your personal information when you use our service. Please read this policy
          carefully. By using the Service, you consent to the data practices described in this
          policy.
        </p>
      </>
    ),
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <li>
            <strong>Service Delivery:</strong> To parse your resume and display your content on your
            public profile
          </li>
          <li>
          ...
          <li>
            <strong>Communication:</strong> To send you important updates about your account or the
            Service
          </li>
          <li>
            <strong>Security:</strong> To detect, prevent, and address fraud, abuse, or technical
            issues
          </li>
          <li>
  ...
  },
  {
    ...
    body: (
      <>
        <p className="text-muted-foreground leading-relaxed mb-4">
          We use the following third-party services to operate our platform. Each has their own
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          <li>
            Your data is stored on Cloudflare&apos;s global network infrastructure (SOC 2 Type II,
            ISO 27001 certified)
          </li>
          <li>Cloudflare provides infrastructure-level encryption at rest for all stored data</li>
          <li>All data in transit is encrypted using TLS 1.3</li>
          <li>Database access is restricted to our application only — no direct external access</li>
    ...
    body: (
      <>
        <p className="text-muted-foreground leading-relaxed">
          ...
          you with the Service. Upon account deletion, all your data&mdash;including uploaded files,
          extracted content, and profile information&mdash;is permanently removed from our systems
          within 30 days. Some anonymized, aggregated data may be retained for analytical purposes
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <li>
            <strong>Temporary upload tracking:</strong> Used to associate anonymous uploads with
            your account after login
          </li>
        </ul>

        <h3 className="text-lg font-semibold text-foreground mb-3 mt-6">First-Party Analytics</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
          We use self-hosted, privacy-focused analytics to understand how our service is used and to
          provide portfolio traffic insights to users:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        ...
        <div className="bg-brand-subtle border border-brand/30 rounded-lg p-4 mt-4">
          <p className="text-foreground text-sm font-medium mb-2">Privacy-preserving design:</p>
          <ul className="list-disc pl-6 space-y-1 text-muted-foreground text-sm">
            ...
            <li>
              All analytics are self-hosted on our infrastructure — no data shared with third
              parties
            </li>
          </ul>
        </div>
    ...
    body: (
      <>
        <p className="text-muted-foreground leading-relaxed">
          ...
          for other operational, legal, or regulatory reasons. We will notify users of material
          changes at least 30 days in advance by posting the updated policy on this page and
          updating the &quot;Last updated&quot; date. We encourage you to review this Privacy Policy
          periodically. Your continued use of the Service after any changes indicates your
    ...
    body: (
      <>
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          ...
          <p className="text-muted-foreground text-sm">
            For data deletion requests, please use the account deletion feature in your Settings
            page.
          </p>
        </div>
      </>
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="rounded-xl border border-border bg-card shadow-sm p-8 sm:p-12">
            ...
            <div className="prose max-w-none">
              {SECTIONS.map((section, index) => (
                <Section key={section.title} index={index} title={section.title}>
                  {section.body}
                </Section>
              ))}
            </div>
