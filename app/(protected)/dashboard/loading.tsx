    ...
    <div className="min-h-screen bg-slate-50">
      <main className="max-w-[1400px] mx-auto px-4 lg:px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="col-span-full">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl shadow-depth-sm border border-slate-200/60 p-4"
                >
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-depth-sm border border-slate-200/60 p-8">
            {/* Header */}
            <div className="mb-6">
