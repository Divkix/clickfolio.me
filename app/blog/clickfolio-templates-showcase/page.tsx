    ...
    <BlogPostLayout post={post} relatedPosts={relatedPosts}>
      ...
      <section>
        ...
        <p>
          ...
          float with translucent, blurred edges, like frosted glass. The effect is sophisticated and
          modern, giving your resume a premium, almost app-like feel. Best for UI/UX designers,
        ...
        <p>
          ...
          skills, education) gets its own visually distinct card. The result is scannable, engaging,
          and feels less like a document and more like a dashboard. Best for product designers,
        ...
        <p>
          ...
          , giving you the SEO benefits of a website while maintaining ATS compatibility.
        </p>
      ...
      <section>
        ...
        <p>
          ...
          Minimalist Editorial, but you can switch at any time. Premium templates are waiting. share
          with your network to unlock them.
        </p>
        <p>
