...
| Toolchain       | Vite+ (`vp`) — `vite-plus@^0.2.5`; `vite` aliases `@voidzero-dev/vite-plus-core@^0.2.5`; `vitest` resolves to `4.1.10` through the pnpm catalog/overrides |
