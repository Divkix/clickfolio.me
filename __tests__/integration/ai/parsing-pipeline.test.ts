...
describe("AI Parsing Pipeline", () => {
  ...
  describe("parseResumeWithAi", () => {
    ...
    it("should validate final output against schema", async () => {
      ...
      const validation = resumeContentSchema.safeParse(validData);
    ...
    it("should reject invalid resume schema", async () => {
      ...
      const validation = resumeContentSchema.safeParse(invalidData);
  ...
  describe("schema validation", () => {
    it("should validate required fields", () => {
      ...
      const result = resumeContentSchema.safeParse(requiredFields);
      expect(result.success).toBe(true);
    });
    ...
    it("should handle empty arrays for optional fields", () => {
      ...
      const result = resumeContentSchema.safeParse(minimalData);
      expect(result.success).toBe(true);
    });
  });
