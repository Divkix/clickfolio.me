...
- **Oxlint config** in `vite.config.ts:122-173`: plugins `react, typescript, jsx-a11y, oxc` + 1 jsPlugin (`vite-plus/oxlint-plugin`). Ignores **13 patterns** (`dist/**`, `lib/cloudflare-env.d.ts`, `.agent/**`, `.agents/**`, `.claude/**`, `.codex/**`, `.continue/**`, `.cursor/**`, `.gemini/**`, `.opencode/**`, `.pi/**`, `.roo/**`, `.windsurf/**`). Overrides for `__tests__/**` etc. Staged hook: `staged: {"*.{ts,tsx,js,jsx,json,css}": ["vp check --fix"]}` (Vite+ native, not husky).
