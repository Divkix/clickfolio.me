/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv lib/cloudflare-env.d.ts` (hash: 53a4dba75af5b7967143c78faa776970)
// Runtime types generated with workerd@1.20260131.0 2026-01-22 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NODE_ENV: "production";
		AI_MODEL: string;
		CLICKFOLIO_STATUS_DO: DurableObjectNamespace<import("../worker").ClickfolioStatusDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ZONE_ID" | "NODE_ENV" | "AI_MODEL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
