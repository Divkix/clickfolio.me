/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv lib/cloudflare-env.d.ts` (hash: 27d299bbf8dd0bd45afe7a20b8376f29)
// Runtime types generated with workerd@1.20260820.1 2026-01-22 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DISABLE_RATE_LIMITS" | "APP_URL" | "PENDING_UPLOAD_SECRET" | "UNOSEND_API_KEY" | "NEXT_PUBLIC_SITE_NAME" | "NEXT_PUBLIC_SITE_TLD" | "NEXT_PUBLIC_SITE_DOMAIN" | "NEXT_PUBLIC_SITE_TAGLINE" | "NEXT_PUBLIC_SUPPORT_EMAIL" | "CF_CACHE_PURGE_API_TOKEN" | "AI_MODEL" | "CF_AI_GATEWAY_ACCOUNT_ID" | "CF_AI_GATEWAY_ID" | "CF_AIG_AUTH_TOKEN" | "AI_REASONING_EFFORT" | "NEXT_PUBLIC_UMAMI_WEBSITE_ID" | "UMAMI_API_URL" | "UMAMI_USERNAME" | "UMAMI_PASSWORD" | "GOOGLE_SITE_VERIFICATION" | "BING_SITE_VERIFICATION" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLERK_WEBHOOK_SECRET">> {}
}
