...
export function validateEnvironment(): void {
  const requiredVars: EnvVar[] = [
    ...
    { key: 'R2_ACCESS_KEY_ID', value: process.env.R2_ACCESS_KEY_ID, required: true },
    { key: 'R2_SECRET_ACCESS_KEY', value: process.env.R2_SECRET_ACCESS_KEY, required: true },
    { key: 'R2_BUCKET_NAME', value: process.env.R2_BUCKET_NAME, required: true },

    // Replicate
    { key: 'REPLICATE_API_TOKEN', value: process.env.REPLICATE_API_TOKEN, required: true },
  ]
