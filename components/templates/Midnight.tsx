  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-200 font-sans selection:bg-amber-500/30 selection:text-amber-200 relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-28">
        <main>
          {/* Header Section */}
          <header className="flex flex-col items-center text-center mb-20 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-4 duration-700">
            <div className="relative mb-8 group">
              <div className="absolute -inset-1 bg-linear-to-br from-amber-500/40 to-purple-600/0 rounded-full blur opacity-40 group-hover:opacity-70 transition-opacity duration-500"></div>
            ...
            <div className="flex items-center gap-4 text-sm text-neutral-500 border border-white/5 bg-white/5 px-4 py-1.5 rounded-full backdrop-blur-sm">
              {content.contact.location && (
                <div className="flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5 text-amber-500/80" aria-hidden="true" />
                  <span>{content.contact.location}</span>
                </div>
              )}
              <div className="w-1 h-1 rounded-full bg-neutral-700" aria-hidden="true"></div>
          ...
          {flatSkills.length > 0 && (
            <div className="mb-24 relative">
              ...
              <div className="overflow-hidden flex py-4 border-y border-white/5 bg-white/2">
                <div className="flex motion-safe:animate-[marquee_40s_linear_infinite] gap-8 px-4">
          ...
          {content.summary && (
            <section className="mb-24 max-w-2xl mx-auto">
              <h2 className="text-xl md:text-2xl font-serif text-white mb-6 flex items-center gap-3">
                <span className="w-8 h-px bg-amber-500/50" aria-hidden="true"></span>
                About
              </h2>
                          ...
                          {limitedHighlights.length > 0 && (
                            <ul className="space-y-2">
                              {limitedHighlights.map((highlight, i) => (
                                ...
                                >
                                  <span
                                    className="mt-1.5 w-1 h-1 rounded-full bg-neutral-700 shrink-0"
                                    aria-hidden="true"
                                  />
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {content.projects.map((project, index) => (
                      <div
                        key={index}
                        className="group relative bg-neutral-900/40 border border-white/5 hover:border-white/10 rounded-2xl p-6 md:p-8 transition-[border-color,transform,box-shadow] duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/50 overflow-hidden"
                      >
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row gap-6 md:items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              {project.url && (
                                <ExternalLink
                                  className="w-3.5 h-3.5 text-neutral-600 group-hover:text-amber-500 transition-colors"
                                  aria-hidden="true"
                                />
                              )}
                            </div>
            ...
            <div className="md:col-span-4 space-y-12">
              ...
              {content.certifications && content.certifications.length > 0 && (
                <section className="bg-neutral-900/20 rounded-2xl p-6 border border-white/5 backdrop-blur-sm">
                  <h2 className="text-lg font-serif text-white mb-6 flex items-center gap-2">
                    <div
                      className="w-4 h-4 rounded-full border border-amber-500 flex items-center justify-center"
                      aria-hidden="true"
                    >
        ...
        <footer className="mt-32 pt-16 border-t border-white/5 text-center">
                ...
                .map((link) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-11 h-11 rounded-full bg-neutral-900 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:border-amber-500/50 hover:scale-110 transition-[color,border-color,transform] duration-300"
          ...
          <p className="text-neutral-600 text-xs mt-8" suppressHydrationWarning>
