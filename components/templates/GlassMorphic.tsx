...
const GlassMorphic: React.FC<TemplateProps> = ({ content, profile }) => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-slate-200 font-sans relative overflow-x-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
      {/* Dynamic Background */}
      <div className="fixed inset-0 z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-[100px] animate-blob mix-blend-screen"></div>
        ...
        <div className="absolute bottom-[-10%] left-[20%] w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[120px] animate-blob animation-delay-4000 mix-blend-screen"></div>
        {/* Grain Overlay */}
        <div
            ...
            <div className="relative border-l border-white/10 ml-3 md:ml-6 space-y-12">
              {content.experience.map((job, index) => (
                <div key={index} className="relative pl-8 md:pl-12 group">
                  {/* Timeline Dot */}
                  <div className="absolute -left-[5px] top-2 w-[10px] h-[10px] rounded-full bg-neutral-950 border border-white/30 group-hover:border-indigo-400 group-hover:scale-125 transition-all duration-300"></div>
