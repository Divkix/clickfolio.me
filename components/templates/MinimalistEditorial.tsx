...
// Helper Component for section headers with ornament divider
        ...
        <main className="max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-40">
          ...
          <header className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-32 lg:mb-48 border-b border-black/10 pb-24">
            <div className="lg:col-span-8">
              <h1 className="flex flex-col font-serif-me text-[clamp(4rem,10vw,8rem)] leading-[0.9] tracking-tighter text-black">
          ...
          {experience && experience.length > 0 && (
            <section className="mb-32" aria-label="Experience">
                ...
                {experience.map((job, index) => (
                  ...
                  >
                    ...
                    <div className="md:col-span-5">
                      <h3 className="text-2xl font-serif-me italic text-neutral-800 mb-2">
                        {job.title}
                      </h3>
                      {job.location && (
          ...
          {projects && projects.length > 0 && (
            <section className="mb-32" aria-label="Selected works">
              ...
              <div className="flex flex-col">
                {projects.map((project, index) => (
                  <a
                    ...
                    className="group relative flex flex-col md:flex-row md:items-center justify-between border-t border-black/10 py-10 hover:bg-[#C4704F] hover:text-white transition-colors duration-500 px-2 -mx-2 rounded-sm"
                  >
                    <div className="md:w-1/2">
                      <h3 className="text-4xl md:text-5xl font-serif-me font-light tracking-tight mb-2 group-hover:italic transition-colors">
                        {project.title}
                      </h3>
