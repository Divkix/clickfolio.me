      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-border pt-6">
          <p className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-center text-xs text-muted-foreground">
            ...
            <span className="text-foreground/80">Powered by Cloudflare</span>
            <span aria-hidden="true">&middot;</span>
            <a
              href="https://github.com/divkix/clickfolio.me"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-11 items-center gap-1 px-2 underline-offset-4 transition-colors hover:text-foreground hover:underline"
            >
