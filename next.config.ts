    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline' https://s.clickfolio.me https://analytics.divkix.me https://clerk.clickfolio.me https://*.clerk.accounts.dev https://challenges.cloudflare.com https://*.protect.clerk.com https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://s.clickfolio.me https://analytics.divkix.me https://accounts.google.com https://clerk.clickfolio.me https://*.clerk.accounts.dev https://*.protect.clerk.com:* https://cloudflareinsights.com; worker-src 'self' blob:; frame-src 'self' https://challenges.cloudflare.com https://*.clerk.accounts.dev https://*.protect.clerk.com; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none'",
          },
        ],
      },
    ];
